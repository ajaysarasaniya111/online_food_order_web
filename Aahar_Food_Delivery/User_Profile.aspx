<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Profile.aspx.cs" Inherits="Aahar_Food_Delivery.User_Profile" %>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                       <image src="Client_userProfile/<%#Eval("image") %>" alt="Admin" class="rounded-circle" width="150"></image>
                    <div class="mt-3">
                      <h4><asp:Label ID="Label1" runat="server" Text='<%#Eval("Name") %>'></asp:Label></h4>
                      <p class="text-secondary mb-1"><asp:Label ID="Label2" runat="server" Text='<%#Eval("address") %>'></asp:Label></p>
                      <p class="text-muted font-size-sm"> </p>
                       <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-primary" OnClick="LinkButton1_Click">LogOut..</asp:LinkButton>
              ...
              <div class="card mb-4">
                <div class="card-body">
                 ...
                 <center><h2>Order History</h2></center>
                  <asp:GridView ID="GridView1" runat="server" CssClass="table" AutoGenerateColumns="False" ClientIDMode="Predictable">
                    <Columns>
                        <asp:TemplateField HeaderText="Product Name">
                         ...
                         <asp:TemplateField HeaderText="Quantity">
                            <ItemTemplate>
                                 <asp:Label ID="Label8" runat="server" Text='<%# Eval("quantity")%>'></asp:Label></td>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Price">
                            <ItemTemplate>
                                <asp:Label ID="Label9" runat="server" Text='<%# Eval("final_price")%>'></asp:Label></td>
                            </ItemTemplate>
                        </asp:TemplateField>
