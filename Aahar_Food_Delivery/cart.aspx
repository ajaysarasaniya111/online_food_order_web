<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="Aahar_Food_Delivery.cart" %>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="product-thumbnail">
                                               <asp:Image ID="Image1" ImageUrl="" Height="80" Width="80" runat="server" />
                                                </td>
                                            ...
                                            <td class="product-remove">
                                                <asp:LinkButton ID="LinkButton2" runat="server">X</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="cartbox__btn">
                            <ul class="cart__btn__list d-flex flex-wrap flex-md-nowrap flex-lg-nowrap justify-content-between">
                                ...
                                <li><a href="#">Update Cart</a></li>
                                 <li><asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Check Out</asp:LinkButton></li>
                            </ul>
                        </div>
                    </div>
                </div>
